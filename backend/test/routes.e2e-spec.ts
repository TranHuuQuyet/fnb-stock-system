...
import { BatchLabelsService } from '../src/modules/batch-labels/batch-labels.service';
      ...
      providers: [
        ...
        },
        {
          ...
          useValue: {
            ...
            resetPassword: jest
              .fn()
              .mockResolvedValue({ userId: 'user-1', temporaryPassword: '123456' })
          }
        },
        {
          provide: ScanService,
          useValue: {
            scan: jest
              .fn()
              .mockResolvedValue({ resultStatus: 'SUCCESS', resultCode: 'SCAN_OK', message: 'ok' }),
            manualScan: jest
              .fn()
              .mockResolvedValue({ resultStatus: 'SUCCESS', resultCode: 'SCAN_OK', message: 'ok' }),
            sync: jest
              .fn()
              .mockResolvedValue({ data: [{ duplicated: true }], synced: 1, failed: 0 }),
        ...
        },
        {
          ...
          useValue: {
            ...
            getLabel: jest
              .fn()
              .mockResolvedValue({ batchCode: 'BATCH-1', qrCodeValue: 'FNBBATCH:BATCH-1' })
          }
        },
        {
